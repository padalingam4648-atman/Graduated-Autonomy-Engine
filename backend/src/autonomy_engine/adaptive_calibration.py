...
When a class of action gets confirmed by humans over and over without
modification, the engine should stop pestering them for it: the signal is that
this particular action_type is safer than the model thinks. And when a class of
action gets rejected over and over, the engine should stop letting it through so
easily.
...
from autonomy_engine.risk_evaluator import LEVEL_ORDER, AutonomyLevel
